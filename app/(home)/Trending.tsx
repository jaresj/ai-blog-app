  ...
  return (
    <section className='pt-3 pb-10'>
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus quidem quod asperiores est in cumque aliquid ipsam libero blanditiis error sunt repudiandae suscipit ipsa dolor ipsum, assumenda sapiente dignissimos voluptas.
        </p>
      </div>
      ...
      <p className="text-sm">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates vitae doloribus unde dolore consequatur, deserunt eius velit natus, consectetur eaque omnis quibusdam facere corrupti excepturi expedita laudantium. Asperiores, eos aliquam.
      </p>
    </section>
  )
}
